...
public class StudentLogIn {
    ...
    public StudentLogIn(){
        ...
        frame = new JFrame("SAMCIS Student Login");
        ...
        header2 = new JTextArea("   STUDENT LOGIN");
        ...
        login.addActionListener(e -> {
            try {
                if(!uName.getText().isEmpty() && !pass.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null, "Successfully Login.", "Student Logged In", JOptionPane.INFORMATION_MESSAGE);
                    uName.setText("");
                    pass.setText("");
                }
                else {
