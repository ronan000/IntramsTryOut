...
public class CoachLogIn {
    ...
    public CoachLogIn(){
        ...
        frame = new JFrame("SAMCIS Coach Login");
        ...
        header2 = new JTextArea("   COACH LOGIN");
        ...
        login.addActionListener(e -> {
            try {
                if(!uName.getText().isEmpty() && !pass.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null, "Successfully Login.", "Coach Logged In", JOptionPane.INFORMATION_MESSAGE);
                    uName.setText("");
                    pass.setText("");
                }
                else {
