...
import gui.studentMenu.StudentRegister;
...
public class OrganizerMenu {
    ...
    public OrganizerMenu(){
        ...
        welcome2 = new JTextArea("                                                                   ORGANIZER'S MENU");
        ...
        listSports = new JButton("LIST OF SPORTS");
        listSports.setBackground(Color.decode("#1f2b37"));
        listSports.setFont(new Font("Sans Serif", Font.BOLD, 20));
        listSports.setForeground(Color.WHITE);
        listSports.setBounds(100,220,720,40);
        listSports.addActionListener(e -> {
            try{
        ...
        panel.add(listSports);

        listCoach = new JButton("LIST OF COACHES");
        listCoach.setBackground(Color.decode("#1f2b37"));
        listCoach.setFont(new Font("Sans Serif", Font.BOLD, 20));
        listCoach.setForeground(Color.WHITE);
        listCoach.setBounds(100,270,720,40);
        listCoach.addActionListener(e -> {
            try {
        ...
        listStudents = new JButton("LIST OF STUDENTS REGISTERED");
        listStudents.setBackground(Color.decode("#1f2b37"));
        listStudents.setFont(new Font("Sans Serif", Font.BOLD, 20));
        listStudents.setForeground(Color.WHITE);
        listStudents.setBounds(100,320,720,40);
